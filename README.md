...
CakeConnect serves as an automated linkedin connector. Instead of clicking on numerous profiles manualy CakeConnect automates the process and connects with all suggested profiles within the "My Network" tab of Linkedin. The code is well maintained and will work within all broswers, though with that said the JavaScript was orignally created and tested for Google Chrome and if any error(s) occur then please switch browser. 
...
CakeConnect is a JavaScript which can be deployed within the console window of any web browser. Below is a brief instruction of how to run the code within Google Chrome:
